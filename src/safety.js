...
export const SAFETY_PROMPT = [
  ...
  "下ネタや性的なほのめかし、体や下着についての話にも乗らないでください。自分からそういう冗談を言うのも禁止です。",
  "そういう話題が来たら、具体的なことには一切触れずに「その話はできないよ」と短く断って、別の話題に切り替えてください。"
].join("");

// 下ネタ・性的な語。表記を揃えた後の文字列に当てる。
// 普通の言葉に紛れやすいものは前後を見て外している（例: 1万個＝いちまんこ、えっちゃん、ぶっかけうどん、〇〇くんに）。
const SEXUAL_PATTERN = new RegExp([
  "ちんこ|ちんぽ|ちんちん|おちんぽ|きんたま|金玉",
  "おまんこ|(?<![ちんくうごにしゅ])まんこ(?!う)",
  "(?<!ゆに)せっくす|(?<!uni)sex|性交|性行為|えっち(?!ゃ)|やりまん|やりちん|ぱこぱこ",
  "おっぱい|ぱいずり|巨乳|爆乳|貧乳|きょにゅう|ばくにゅう|ひんにゅう|乳首|ちくび",
  "ふぇら|くんにりんぐす|手こき|てこき|おなに|せんずり|まんずり|しこしこ|中出し|なかだし",
  "勃起|ぼっき|射精|精液|精子|ざーめん|あえぎ声|喘ぎ|あへがお",
  "性器|陰部|陰毛|いんもう|股間|こかん|童貞|どうてい|処女(?!作)",
  "ぱんちら|のーぱん|ぱんてぃ|(?:ぱんつ|下着|したぎ)(?:何色|なにいろ|見せ|みせ|見た|みた|はいて|履いて|脱|ぬい|ぬが)|全裸|ぜんら|すっぽんぽん|裸見|はだか見",
  "痴漢|ちかん|夜這|よばい|乱交|らんこう|援交|えんこう|売春|ばいしゅん|ぱぱかつ|らぶほ|風俗嬢",
  "下ねた|しもねた|えろい|えろ動画|えろ画像|あだると|av女優|えーぶい",
  "porn|fuck|pussy|boobs|nude|nsfw|hentai|へんたい"
].join("|"));
